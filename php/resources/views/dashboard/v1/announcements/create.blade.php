...
@section('breadcrumbs', Breadcrumbs::render('v1AnnouncementCreate'))

@section('content')
    <div class="card mb-4">
        <!-- Card header -->
        <div class="card-header">
            <h3 class="mb-0">{{__('Create announcement')}}</h3>
        </div>
        <!-- Card body -->
        <div class="card-body">
            <!-- Form groups used in grid -->
            <form action="{{route('dashboard.v1.announcements.store')}}" method="post" enctype="multipart/form-data">
                @csrf
